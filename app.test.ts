...
describe('POST /rest/api/2/issue', () => {
  it('should call IssueService.createIssue and return 201 with the created issue', async () => {
    ...
    expect(response.body).toHaveProperty('summary', 'Test issue'); // Reflects input summary
    expect(response.body).toHaveProperty('description', 'This is a test issue description'); // Reflects input description
    expect(response.body).toHaveProperty('status', 'Todo'); // Reflects input status
    expect(response.body).toHaveProperty('createdAt'); // Generated by service
    expect(response.body).toHaveProperty('updatedAt'); // Generated by service
