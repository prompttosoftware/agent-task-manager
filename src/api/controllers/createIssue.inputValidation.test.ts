...
describe('createIssue Controller - Direct Validation Scenarios', () => {
  ...
  it('should return 400 with error messages if issueType is missing', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith({
      errorMessages: ["Missing or invalid 'issuetype' name in request fields."],
      errors: {},
    });
  ...
  it('should return 400 with error messages if summary is missing or empty', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith({
      errorMessages: ["Missing or invalid 'summary' in request fields."],
      errors: {},
    });
