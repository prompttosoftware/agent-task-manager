...
export class InitialSchema1749521052396 implements MigrationInterface {
    name = 'InitialSchema1749521052396'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "attachment" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "filename" varchar NOT NULL, "storedFilename" varchar NOT NULL, "mimetype" varchar NOT NULL, "size" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "issueId" integer, "authorId" integer NOT NULL)`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_eb96784ad7f49730d6e908950c" ON "attachment" ("storedFilename") `);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "userKey" varchar NOT NULL, "displayName" varchar NOT NULL, "emailAddress" varchar NOT NULL)`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_f895fe808c3662976bee0b530e" ON "user" ("userKey") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_eea9ba2f6e1bb8cb89c4e672f6" ON "user" ("emailAddress") `);
        await queryRunner.query(`DROP INDEX "IDX_eb96784ad7f49730d6e908950c"`);
        await queryRunner.query(`CREATE TABLE "temporary_attachment" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "filename" varchar NOT NULL, "storedFilename" varchar NOT NULL, "mimetype" varchar NOT NULL, "size" integer NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "issueId" integer, "authorId" integer NOT NULL, CONSTRAINT "FK_54f51431f696f4d3b8436475e88" FOREIGN KEY ("issueId") REFERENCES "issue" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_c8cacbfb04fdb38644032d02aa5" FOREIGN KEY ("authorId") REFERENCES "user" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_f895fe808c3662976bee0b530e"`);
